...
################################################################################
## Form generated from reading UI file '写入单元格.ui'
##
...
class Ui_InstructionEditor(object):
    def setupUi(self, InstructionEditor):
        ...
        self.parameter_4 = QPlainTextEdit(self.parameterGroupBox)
        self.parameter_4.setObjectName(u"parameter_4")
        self.parameter_4.setMinimumSize(QSize(0, 80))
    ...
    def retranslateUi(self, InstructionEditor):
        InstructionEditor.setWindowTitle(QCoreApplication.translate("InstructionEditor", u"\u5199\u5165\u5355\u5143\u683c", None))
        self.titleLabel.setText(QCoreApplication.translate("InstructionEditor", u"\u5199\u5165\u5355\u5143\u683c", None))
        self.titleLabel.setStyleSheet(QCoreApplication.translate("InstructionEditor", u"font-size: 18px; font-weight: 600;", None))
        self.parameterGroupBox.setTitle(QCoreApplication.translate("InstructionEditor", u"\u5199\u5165\u5355\u5143\u683c\u53c2\u6570", None))
        ...
        self.parameterLabel_3.setText(QCoreApplication.translate("InstructionEditor", u"\u6309\u5faa\u73af\u6b21\u6570\u9012\u589e\u884c", None))
        self.parameter_3.setText(QCoreApplication.translate("InstructionEditor", u"\u542f\u7528", None))
        self.parameterLabel_4.setText(QCoreApplication.translate("InstructionEditor", u"\u5199\u5165\u6587\u672c", None))
        self.parameter_4.setPlainText("")
