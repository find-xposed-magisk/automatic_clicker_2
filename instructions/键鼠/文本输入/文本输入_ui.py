...
################################################################################
## Form generated from reading UI file '文本输入.ui'
##
...
class Ui_InstructionEditor(object):
    def setupUi(self, InstructionEditor):
        ...
        self.parameter_0 = QPlainTextEdit(self.parameterGroupBox)
        ...
        self.parameter_1 = QCheckBox(self.parameterGroupBox)
        self.parameter_1.setObjectName(u"parameter_1")
        self.parameter_1.setChecked(False)
    ...
    def retranslateUi(self, InstructionEditor):
        InstructionEditor.setWindowTitle(QCoreApplication.translate("InstructionEditor", u"\u6587\u672c\u8f93\u5165", None))
        self.titleLabel.setText(QCoreApplication.translate("InstructionEditor", u"\u6587\u672c\u8f93\u5165", None))
        self.titleLabel.setStyleSheet(QCoreApplication.translate("InstructionEditor", u"font-size: 18px; font-weight: 600;", None))
        self.parameterGroupBox.setTitle(QCoreApplication.translate("InstructionEditor", u"\u6587\u672c\u8f93\u5165\u53c2\u6570", None))
        self.parameterLabel_0.setText(QCoreApplication.translate("InstructionEditor", u"\u8f93\u5165\u5185\u5bb9 *", None))
        self.parameter_0.setPlainText("")
        self.parameterLabel_1.setText(QCoreApplication.translate("InstructionEditor", u"\u7279\u6b8a\u63a7\u4ef6\u624b\u52a8\u8f93\u5165", None))
        self.parameter_1.setText(QCoreApplication.translate("InstructionEditor", u"\u542f\u7528", None))
