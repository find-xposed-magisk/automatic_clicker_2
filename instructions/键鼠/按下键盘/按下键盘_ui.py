...
################################################################################
## Form generated from reading UI file '按下键盘.ui'
##
...
class Ui_InstructionEditor(object):
    def setupUi(self, InstructionEditor):
        ...
        self.parameter_1.setMinimum(0)
        self.parameter_1.setMaximum(3600000)
        self.parameter_1.setValue(50)
    ...
    def retranslateUi(self, InstructionEditor):
        InstructionEditor.setWindowTitle(QCoreApplication.translate("InstructionEditor", u"\u6309\u4e0b\u952e\u76d8", None))
        self.titleLabel.setText(QCoreApplication.translate("InstructionEditor", u"\u6309\u4e0b\u952e\u76d8", None))
        self.titleLabel.setStyleSheet(QCoreApplication.translate("InstructionEditor", u"font-size: 18px; font-weight: 600;", None))
        self.parameterGroupBox.setTitle(QCoreApplication.translate("InstructionEditor", u"\u6309\u4e0b\u952e\u76d8\u53c2\u6570", None))
        self.parameterLabel_0.setText(QCoreApplication.translate("InstructionEditor", u"\u6309\u952e\uff08\u7528 + \u7ec4\u5408\uff09 *", None))
        self.parameter_0.setText(QCoreApplication.translate("InstructionEditor", u"enter", None))
        self.parameterLabel_1.setText(QCoreApplication.translate("InstructionEditor", u"\u6309\u538b\u65f6\u957f\uff08\u6beb\u79d2\uff09", None))
