...
################################################################################
## Form generated from reading UI file '多图点击.ui'
##
...
class Ui_InstructionEditor(object):
    def setupUi(self, InstructionEditor):
        ...
        self.parameter_0 = QPlainTextEdit(self.parameterContainer_0)
        self.parameter_0.setObjectName(u"parameter_0")
        self.parameter_0.setMinimumSize(QSize(0, 80))
    ...
    def retranslateUi(self, InstructionEditor):
        InstructionEditor.setWindowTitle(QCoreApplication.translate("InstructionEditor", u"\u591a\u56fe\u70b9\u51fb", None))
        self.titleLabel.setText(QCoreApplication.translate("InstructionEditor", u"\u591a\u56fe\u70b9\u51fb", None))
        self.titleLabel.setStyleSheet(QCoreApplication.translate("InstructionEditor", u"font-size: 18px; font-weight: 600;", None))
        self.parameterGroupBox.setTitle(QCoreApplication.translate("InstructionEditor", u"\u591a\u56fe\u70b9\u51fb\u53c2\u6570", None))
        self.parameterLabel_0.setText(QCoreApplication.translate("InstructionEditor", u"\u56fe\u50cf\u8def\u5f84\uff08\u6bcf\u884c\u4e00\u4e2a\uff09 *", None))
        self.parameter_0.setPlainText("")
        ...
        self.parameter_1.setItemText(2, QCoreApplication.translate("InstructionEditor", u"\u53f3\u952e\u5355\u51fb", None))
        self.parameter_1.setItemText(3, QCoreApplication.translate("InstructionEditor", u"\u53f3\u952e\u53cc\u51fb", None))
        self.parameter_1.setItemText(4, QCoreApplication.translate("InstructionEditor", u"\u4ec5\u79fb\u52a8\u9f20\u6807", None))

        self.parameterLabel_2.setText(QCoreApplication.translate("InstructionEditor", u"\u5168\u90e8\u672a\u627e\u5230", None))
