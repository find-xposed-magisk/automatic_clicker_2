...
################################################################################
## Form generated from reading UI file '滚轮滑动.ui'
##
...
class Ui_InstructionEditor(object):
    def setupUi(self, InstructionEditor):
        ...
        self.parameter_3.setMaximum(100000)
        ...
        self.parameter_4 = QSpinBox(self.parameterGroupBox)
        self.parameter_4.setObjectName(u"parameter_4")
        self.parameter_4.setMinimum(1)
        self.parameter_4.setMaximum(100000)
        self.parameter_4.setValue(10)
        ...
        self.parameter_1.setCurrentIndex(1)
    ...
    def retranslateUi(self, InstructionEditor):
        InstructionEditor.setWindowTitle(QCoreApplication.translate("InstructionEditor", u"\u6eda\u8f6e\u6ed1\u52a8", None))
        self.titleLabel.setText(QCoreApplication.translate("InstructionEditor", u"\u6eda\u8f6e\u6ed1\u52a8", None))
        self.titleLabel.setStyleSheet(QCoreApplication.translate("InstructionEditor", u"font-size: 18px; font-weight: 600;", None))
        self.parameterGroupBox.setTitle(QCoreApplication.translate("InstructionEditor", u"\u6eda\u8f6e\u6ed1\u52a8\u53c2\u6570", None))
        self.parameterLabel_0.setText(QCoreApplication.translate("InstructionEditor", u"\u6ed1\u52a8\u7c7b\u578b", None))
        self.parameter_0.setItemText(0, QCoreApplication.translate("InstructionEditor", u"\u6eda\u8f6e\u6ed1\u52a8", None))
        self.parameter_0.setItemText(1, QCoreApplication.translate("InstructionEditor", u"\u968f\u673a\u6eda\u8f6e\u6ed1\u52a8", None))

        self.parameterLabel_1.setText(QCoreApplication.translate("InstructionEditor", u"\u65b9\u5411", None))
        self.parameter_1.setItemText(0, QCoreApplication.translate("InstructionEditor", u"\u5411\u4e0a", None))
        self.parameter_1.setItemText(1, QCoreApplication.translate("InstructionEditor", u"\u5411\u4e0b", None))

        self.parameterLabel_2.setText(QCoreApplication.translate("InstructionEditor", u"\u8ddd\u79bb", None))
        self.parameterLabel_3.setText(QCoreApplication.translate("InstructionEditor", u"\u968f\u673a\u6700\u5c0f\u8ddd\u79bb", None))
        self.parameterLabel_4.setText(QCoreApplication.translate("InstructionEditor", u"\u968f\u673a\u6700\u5927\u8ddd\u79bb", None))
