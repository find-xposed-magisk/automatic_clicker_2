...
################################################################################
## Form generated from reading UI file '获取鼠标位置.ui'
##
...
class Ui_InstructionEditor(object):
    ...
    def retranslateUi(self, InstructionEditor):
        InstructionEditor.setWindowTitle(QCoreApplication.translate("InstructionEditor", u"\u83b7\u53d6\u9f20\u6807\u4f4d\u7f6e", None))
        self.titleLabel.setText(QCoreApplication.translate("InstructionEditor", u"\u83b7\u53d6\u9f20\u6807\u4f4d\u7f6e", None))
