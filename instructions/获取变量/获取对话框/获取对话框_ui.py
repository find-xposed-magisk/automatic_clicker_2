...
################################################################################
## Form generated from reading UI file '获取对话框.ui'
##
...
class Ui_InstructionEditor(object):
    def setupUi(self, InstructionEditor):
        ...
        self.parameter_2 = QPlainTextEdit(self.parameterGroupBox)
        self.parameter_2.setObjectName(u"parameter_2")
        self.parameter_2.setMinimumSize(QSize(0, 80))
    ...
    def retranslateUi(self, InstructionEditor):
        InstructionEditor.setWindowTitle(QCoreApplication.translate("InstructionEditor", u"\u83b7\u53d6\u5bf9\u8bdd\u6846", None))
        self.titleLabel.setText(QCoreApplication.translate("InstructionEditor", u"\u83b7\u53d6\u5bf9\u8bdd\u6846", None))
        self.titleLabel.setStyleSheet(QCoreApplication.translate("InstructionEditor", u"font-size: 18px; font-weight: 600;", None))
        self.parameterGroupBox.setTitle(QCoreApplication.translate("InstructionEditor", u"\u83b7\u53d6\u5bf9\u8bdd\u6846\u53c2\u6570", None))
