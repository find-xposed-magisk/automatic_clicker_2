...
################################################################################
## Form generated from reading UI file '运行外部文件.ui'
##
...
class Ui_InstructionEditor(object):
    ...
    def retranslateUi(self, InstructionEditor):
        InstructionEditor.setWindowTitle(QCoreApplication.translate("InstructionEditor", u"\u8fd0\u884c\u5916\u90e8\u6587\u4ef6", None))
        self.titleLabel.setText(QCoreApplication.translate("InstructionEditor", u"\u8fd0\u884c\u5916\u90e8\u6587\u4ef6", None))
        self.titleLabel.setStyleSheet(QCoreApplication.translate("InstructionEditor", u"font-size: 18px; font-weight: 600;", None))
        self.parameterGroupBox.setTitle(QCoreApplication.translate("InstructionEditor", u"\u8fd0\u884c\u5916\u90e8\u6587\u4ef6\u53c2\u6570", None))
        self.parameterLabel_0.setText(QCoreApplication.translate("InstructionEditor", u"\u6587\u4ef6\u8def\u5f84 *", None))
        self.parameter_0.setText("")
        self.auxiliary_0.setText(QCoreApplication.translate("InstructionEditor", u"\u6d4f\u89c8\u6587\u4ef6", None))
        self.parameterLabel_1.setText(QCoreApplication.translate("InstructionEditor", u"\u542f\u52a8\u53c2\u6570", None))
