...
################################################################################
## Form generated from reading UI file '运行Python.ui'
##
...
class Ui_InstructionEditor(object):
    ...
    def retranslateUi(self, InstructionEditor):
        InstructionEditor.setWindowTitle(QCoreApplication.translate("InstructionEditor", u"\u8fd0\u884cPython", None))
        self.titleLabel.setText(QCoreApplication.translate("InstructionEditor", u"\u8fd0\u884cPython", None))
        self.titleLabel.setStyleSheet(QCoreApplication.translate("InstructionEditor", u"font-size: 18px; font-weight: 600;", None))
        self.parameterGroupBox.setTitle(QCoreApplication.translate("InstructionEditor", u"\u8fd0\u884cPython\u53c2\u6570", None))
        self.parameterLabel_0.setText(QCoreApplication.translate("InstructionEditor", u"Python\u4ee3\u7801 *", None))
        self.parameter_0.setPlainText("")
        self.auxiliary_0.setText(QCoreApplication.translate("InstructionEditor", u"\u8f7d\u5165\u4ee3\u7801", None))
