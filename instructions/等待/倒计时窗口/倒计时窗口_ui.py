...
################################################################################
## Form generated from reading UI file '倒计时窗口.ui'
##
...
class Ui_InstructionEditor(object):
    def setupUi(self, InstructionEditor):
        ...
        self.parameter_1 = QPlainTextEdit(self.parameterGroupBox)
        self.parameter_1.setObjectName(u"parameter_1")
        self.parameter_1.setMinimumSize(QSize(0, 80))
        ...
        self.parameter_2.setMaximum(86400)
    ...
    def retranslateUi(self, InstructionEditor):
        InstructionEditor.setWindowTitle(QCoreApplication.translate("InstructionEditor", u"\u5012\u8ba1\u65f6\u7a97\u53e3", None))
        self.titleLabel.setText(QCoreApplication.translate("InstructionEditor", u"\u5012\u8ba1\u65f6\u7a97\u53e3", None))
        self.titleLabel.setStyleSheet(QCoreApplication.translate("InstructionEditor", u"font-size: 18px; font-weight: 600;", None))
        self.parameterGroupBox.setTitle(QCoreApplication.translate("InstructionEditor", u"\u5012\u8ba1\u65f6\u7a97\u53e3\u53c2\u6570", None))
        self.parameterLabel_0.setText(QCoreApplication.translate("InstructionEditor", u"\u7a97\u53e3\u6807\u9898", None))
        self.parameter_0.setText(QCoreApplication.translate("InstructionEditor", u"\u5012\u8ba1\u65f6", None))
        self.parameterLabel_1.setText(QCoreApplication.translate("InstructionEditor", u"\u63d0\u793a\u5185\u5bb9", None))
        self.parameter_1.setPlainText(QCoreApplication.translate("InstructionEditor", u"\u8bf7\u7a0d\u5019", None))
        self.parameterLabel_2.setText(QCoreApplication.translate("InstructionEditor", u"\u5012\u8ba1\u65f6\u79d2\u6570", None))
