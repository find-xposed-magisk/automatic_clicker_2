...
################################################################################
## Form generated from reading UI file '窗口焦点等待.ui'
##
...
class Ui_InstructionEditor(object):
    def setupUi(self, InstructionEditor):
        ...
        self.parameter_1.setMinimum(0.010000000000000)
        self.parameter_1.setMaximum(60.000000000000000)
        self.parameter_1.setValue(0.200000000000000)
        ...
        self.parameter_2.setValue(30.000000000000000)
    ...
    def retranslateUi(self, InstructionEditor):
        InstructionEditor.setWindowTitle(QCoreApplication.translate("InstructionEditor", u"\u7a97\u53e3\u7126\u70b9\u7b49\u5f85", None))
        self.titleLabel.setText(QCoreApplication.translate("InstructionEditor", u"\u7a97\u53e3\u7126\u70b9\u7b49\u5f85", None))
        self.titleLabel.setStyleSheet(QCoreApplication.translate("InstructionEditor", u"font-size: 18px; font-weight: 600;", None))
        self.parameterGroupBox.setTitle(QCoreApplication.translate("InstructionEditor", u"\u7a97\u53e3\u7126\u70b9\u7b49\u5f85\u53c2\u6570", None))
        self.parameterLabel_0.setText(QCoreApplication.translate("InstructionEditor", u"\u7a97\u53e3\u6807\u9898\u5305\u542b *", None))
        self.parameter_0.setText("")
        self.parameterLabel_1.setText(QCoreApplication.translate("InstructionEditor", u"\u68c0\u6d4b\u9891\u7387", None))
        self.parameterLabel_2.setText(QCoreApplication.translate("InstructionEditor", u"\u8d85\u65f6\u65f6\u95f4", None))
        self.parameterLabel_3.setText(QCoreApplication.translate("InstructionEditor", u"\u7b49\u5f85\u7c7b\u578b", None))
        self.parameter_3.setItemText(0, QCoreApplication.translate("InstructionEditor", u"\u83b7\u5f97\u7126\u70b9", None))
        self.parameter_3.setItemText(1, QCoreApplication.translate("InstructionEditor", u"\u5931\u53bb\u7126\u70b9", None))
